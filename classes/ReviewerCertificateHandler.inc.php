...
class ReviewerCertificateHandler extends Handler {
	...
	function settingsModal($args, $request) {
		...
		// The AjaxModal already controls the available width. Keep the embedded
		// document inside that box so it cannot enlarge the OJS dashboard or
		// create a browser-level horizontal scrollbar.
		$html = '<div class="rc-settings-modal" style="display:block;width:100%;max-width:100%;height:72vh;max-height:720px;min-height:420px;overflow:hidden">';
		$html .= '<iframe title="' . $this->_e(__('plugins.generic.reviewerCertificate.settings.title')) .
			'" src="' . $this->_e($settingsUrl) .
			'" style="display:block;width:100%;max-width:100%;height:100%;border:0;background:#fff" loading="eager"></iframe></div>';
	...
	function settings($args, $request) {
		...
		echo '*{box-sizing:border-box}html,body{max-width:100%;overflow-x:hidden}body{margin:0;background:#eef1f4;color:#252a32;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.top{background:#003b4d;color:#fff;padding:18px 28px;font-size:20px;font-weight:700}.page{max-width:1080px;margin:32px auto;padding:0 18px}.panel{min-width:0;background:#fff;border:1px solid #d8dde3;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,.04)}.head{display:flex;justify-content:space-between;gap:18px;align-items:flex-start;border-bottom:1px solid #e3e6ea;padding-bottom:18px;margin-bottom:22px}.head h1{font-size:24px;margin:0 0 7px}.head p{margin:0;color:#667085;line-height:1.5}.back{color:#0071a1;font-weight:600;text-decoration:none;white-space:nowrap}.notice{padding:13px 15px;margin-bottom:18px;border-left:4px solid}.success{background:#ecfdf3;border-color:#12b76a;color:#067647}.error{background:#fef3f2;border-color:#f04438;color:#b42318}.warning{background:#fffaeb;border-color:#f79009;color:#7a2e0e}.error ul{margin:0;padding-left:20px}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.card{min-width:0;border:1px solid #d8dde3;padding:16px}.card h2{font-size:17px;margin:0 0 13px}.preview{height:120px;background:#f7f8fa;border:1px dashed #c6ccd4;display:flex;align-items:center;justify-content:center;padding:10px}.preview img{max-width:100%;max-height:98px;object-fit:contain}.field{min-width:0;margin-top:14px}.field>label,.public-grid label{display:block;font-weight:650;font-size:13px;margin-bottom:6px}.field input[type=file]{display:block;width:100%;min-width:0;max-width:100%;font-size:12px}.field input[type=number],.signatory input,.public-grid input[type=text],.public-grid input[type=number],.public-grid select{width:100%;min-width:0;height:40px;border:1px solid #aeb5bf;padding:8px 10px;background:#fff}.remove{display:block;font-size:12px;color:#555;line-height:1.4;margin-top:12px}.signatory,.public-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:20px}.signatory label{display:block;font-size:13px;font-weight:650;margin-bottom:6px}.section{margin-top:28px;padding-top:22px;border-top:1px solid #e3e6ea}.section h2{margin:0 0 6px;font-size:19px}.check{display:flex!important;gap:8px;align-items:flex-start;font-weight:500!important;line-height:1.45}.quality{display:flex;gap:12px;margin-top:14px}.quality span{padding:8px 11px;border-radius:6px;background:#f2f4f7;font-size:12px}.actions{display:flex;justify-content:flex-end;align-items:center;gap:14px;border-top:1px solid #e3e6ea;margin-top:24px;padding-top:20px}.save{border:0;background:#0071a1;color:#fff;font-weight:700;padding:11px 20px;cursor:pointer}.help{font-size:13px;color:#667085;margin:0 0 20px}.rc-embedded body{background:#fff}.rc-embedded .top{display:none}.rc-embedded .page{width:100%;max-width:100%;margin:0;padding:0}.rc-embedded .panel{width:100%;max-width:100%;border:0;box-shadow:none;padding:22px}.rc-embedded .head .back,.rc-embedded .actions .back{display:none}@media(max-width:920px){.grid{grid-template-columns:1fr 1fr}.grid .card:last-child{grid-column:1/-1}}@media(max-width:680px){.grid,.signatory,.public-grid{grid-template-columns:1fr}.grid .card:last-child{grid-column:auto}.quality{flex-direction:column}.head{display:block}.back{display:inline-block;margin-top:12px}.rc-embedded .panel{padding:16px}}</style></head><body>';
